...
<!DOCTYPE html>
    ...
    <div class="page-title-section faq">
      <div class="container">
        <div class="headline">
          <h1 class="title">어떻게 도와드릴까요?</h1>
        </div>
        <div class="page-search">
          <form class="search-form">
            <div class="form-group">
              <label for="search_content" class="screen-reader-text">Search Content!</label>
              <input id="search_content" type="text" class="form-control" value="" placeholder="찾고싶은 것을 검색하세요">
            </div>
    ...
    <div id="page-contents">
      <div class="container ">
        ...
        <ul class="nav nav-tabs faq-cat-list">
          <li class="active"><a href="#faq_cat_1" data-toggle="tab"><i class="icon ion-ios-information-outline"></i>많이하는질문</a></li>
          <li><a href="#faq_cat_2" data-toggle="tab"><i class="icon ion-ios-person"></i>계정</a></li>
          <li><a href="#faq_cat_3" data-toggle="tab"><i class="icon ion-eye-disabled"></i>보안</a></li>
          <li><a href="#faq_cat_4" data-toggle="tab"><i class="icon ion-ios-plus-outline"></i>다른 질문 하기</a></li>
        </ul><!-- .faq-cat-list -->
        ...
        <div class="row">
            ...
            <div class="tab-content faq-content">
              ...
              <div class="tab-pane active" id="faq_cat_1">
                <div class="faq-headline">
                	<h3 class="item-title grey"><i class="icon ion-ios-information-outline"></i>많이하는 질문들</h3>
                	<p></p>
                </div>
            ...
            <div class="faq_contact">
              <div class="faq-headline">
                <h3 class="item-title grey"><i class="icon ion-ios-help-outline"></i>궁금증이 안풀렸나요?</h3>
                <p>궁금한점이 있으면 문의해주세요.</p>
              </div>
              <div class="reach-out">
                <div class="method by-forum"><a href="#"><i class="icon ion-chatboxes"></i>채팅문의</a></div>
                <div class="method by-email"><a href="#"><i class="icon ion-email"></i>이메일문의</a></div>
                <div class="method by-phone"><a href="#"><i class="icon ion-android-call"></i>전화문의</a></div>
              </div>
            </div>
          </div>
        </div>
