			...
			<div class="container">
				...
				<div class="collapse navbar-collapse"
                  ...
                  <li><a href="edit-profile-basic.jsp">Edit Profile</a></li> -->
								<li><a
									href="${pageContext.request.contextPath}/sns/view/contact/contact.jsp">문의하기</a></li>
								<li><a
					...
					<div class="reg-form-container">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="register">
								...
								<!--Register Form-->
								<form  action="register.do" method ="post" name="registration_form" id='registration_form'
									class="form-inline">
									<div class="row">
										<div class="form-group col-xs-6">
											<label for="lastname" class="sr-only">이름</label> <input
												id="lastname" class="form-control input-group-lg"
												type="text" name="name" value="${param.name}"title="Enter last name"
												placeholder="name" />
										</div>
									</div>
									<div class="row">
										<div class="form-group col-xs-12">
											<label for="email" class="sr-only">아이디</label> <input
												...
												name="id"value="${param.id}" title="Enter Email" placeholder="id" />
										</div>
									</div>
									<div class="row">
										<div class="form-group col-xs-12">
											<label for="password" class="sr-only">비밀번호</label> <input
												...
												type="password" name="pw" value="${param.pw}" title="Enter password"
									...
									<div class="row">
										<div class="form-group col-xs-12">
											<label for="password" class="sr-only">이메일</label> <input
												id="password" class="form-control input-group-lg"
												type="email" name="email"  value="${param.email}"title="Enter password"
												placeholder="e-mail" />
										</div>
									</div>
									<div class="row">
										<div class="form-group col-xs-12">
											<label for="password" class="sr-only">휴대폰번호</label> <input
												id="password" class="form-control input-group-lg"
												type="name" name="ph" value="${param.ph}" title="Enter password"
												placeholder="phone number" />
										</div>
									</div>
																		<div class="row">
										<div class="form-group col-xs-12">
											<label for="password" class="sr-only">소속/지역</label> <input
												id="password" class="form-control input-group-lg"
												type="name" name="loc" value="${param.loc}" title="Enter password"
									...
									<div class="row">
										<div class="form-group col-xs-6">
											<label for="country" class="sr-only"></label> <select
												...
												<option value="country" disabled selected>국가</option>
												<option value="PRK">대한민국</option>
										...
										<div class="form-group col-xs-6">
											<label for="city" class="sr-only">지역</label> <input id="city"
												class="form-control input-group-lg reg_name" type="text"
												name="city" title="Enter city" placeholder="지역" />
										</div>
									</div>
										<p>
									<a href="#">이미 계정이 있습니까?</a>
								</p>
							...
							<div class="tab-pane" id="login">
								<h3>로그인</h3>
								<p class="text-muted">아이디로 로그인</p>

								<!--Login Form-->
								<form name="Login_form" id='Login_form'>
									<div class="row">
										<div class="form-group col-xs-12">
											<label for="my-email" class="sr-only">ID</label> <input
												id="my-email" class="form-control input-group-lg"
								...
								<button onclick="location.href='${pageContext.request.contextPath}/sns/view/newsfeed/newsfeed.jsp' "class="btn btn-primary">로그인</button>
							</div>
						</div>
					</div>
				</div>
