				...
				<div class="reg-form-container">
					...
					<div class="reg-options">
						<ul class="nav nav-tabs">
							<li><a href="#register" data-toggle="tab">비밀번호 찾기</a></li>
							<li class="active"><a href="#login" data-toggle="tab">아이디 찾기</a></li>
						</ul>
						<!--Tabs End-->
					</div>
								...
								<div class="row">
									<div class="form-group col-xs-6">
										<label for="lastname" class="sr-only">이름</label> <input
											...
											name="name" title="Enter last name" placeholder="name" />
									</div>
								</div>
								<div class="row">
									<div class="form-group col-xs-12">
										<label for="email" class="sr-only">아이디</label> <input
											...
											name="id" title="Enter Email" placeholder="id" />
									</div>
								</div>
								<div class="row">
									<div class="form-group col-xs-12">
										<label for="" class="sr-only">이메일</label> <input id=""
											class="form-control input-group-lg" type="email" name="email"
											title="Enter password" placeholder="email" />
									</div>
								</div>
								<p>
									<a href="#">이메일을 잊어버렸습니까?</a>
