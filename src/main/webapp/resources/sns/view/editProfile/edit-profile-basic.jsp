				...
				<div class="row">
					<div class="col-md-3">
						<div class="profile-info">
							...
							<h3>Sarah Cruiz사용자이름</h3>
							<p class="text-muted">사용자 직업 Creative Director</p>
						</div>
					</div>
					<div class="col-md-9">
				...
				<div class="col-md-3">
					...
					<ul class="edit-menu">
						...
						<li><i class="icon ion-ios-briefcase-outline"></i><a
							href="${pageContext.request.contextPath}/sns/view/editProfile/edit-profile-work-edu.jsp">학력
								및 직장</a></li>
              ...
              ================================================= -->
					<div class="edit-profile-container">
						<div class="block-title">
							<h4 class="grey">
								<i class="icon ion-android-checkmark-circle"></i>개인정보를 변경하세요.
							</h4>
							<div class="line"></div>
							<p>여기서 원하는 정보를 수정 및 변경하세요.</p>
							<div class="line"></div>
						</div>
                        ...
                        <input id="name" class="form-control input-group-lg" type="text" name="name" title="Enter name" placeholder="name" value="홍길동" />
                      </div>
								</div>
								<div class="row">
									<div class="form-group col-xs-12">
										<label for="email">이메일</label> <input id="email"
											...
											title="Enter Email" placeholder="My Email"
								...
								<div class="form-group gender">
									<span class="custom-label"><strong>성별: </strong></span> <label
