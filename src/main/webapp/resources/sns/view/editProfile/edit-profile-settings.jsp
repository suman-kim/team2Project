            ...
            <div class="row">
              ...
              <div class="col-md-9">
                ...
                <ul class="follow-me list-inline">
                  <li>1,299 people following her그녀</li>
          ...
          <div class="row">
            <div class="col-md-3">
              ...
              <ul class="edit-menu">
                ...
                <li class="active"><i class="icon ion-ios-settings"></i><a href="${pageContext.request.contextPath}/sns/view/editProfile/edit-profile-settings.jsp">계정설정</a></li>
            ...
            <div class="col-md-7">
              ...
              <div class="edit-profile-container">
                <div class="block-title">
                  <h4 class="grey"><i class="icon ion-ios-settings"></i>계정 설정</h4>
                  <div class="line"></div>
                </div>
                <div class="edit-block">
                    ...
                    <div class="row">
                      <div class="col-sm-9">
                        <div class="switch-description">
                          <div><strong>비공개 계정</strong></div>
                          <p>다른 사용자가 내 계정을 볼 수 없습니다.</p>
                        </div>
                      </div>
                      <div class="col-sm-3">
                  ...
                  <div class="settings-block">
                    <div class="row">
                      <div class="col-sm-9">
                        <div class="switch-description">
                          <div><strong>좋아요 알림 설정</strong></div>
                          <p>내 게시물에 대한 좋아요 알림</p>
                        </div>
                      </div>
                      <div class="col-sm-3">
                        <div class="toggle-switch">
                  ...
                  <div class="settings-block">
                    <div class="row">
                      <div class="col-sm-9">
                        <div class="switch-description">
                          <div><strong>팔로워 알림 설정</strong></div>
                          <p>내 팔로워가 추가 되었을때 알림</p>
                        </div>
                      </div>
                      <div class="col-sm-3">
                        <div class="toggle-switch">
                  ...
                  <div class="settings-block">
                    <div class="row">
                      <div class="col-sm-9">
                        <div class="switch-description">
                          <div><strong>댓글 알림 설정</strong></div>
                          <p>내 게시글에 댓글이 작성되면 알림 설정</p>
                        </div>
                      </div>
                      <div class="col-sm-3">
                        <div class="toggle-switch">
                  ...
                  <div class="settings-block">
                    <div class="row">
                      <div class="col-sm-9">
                        <div class="switch-description">
                          <div><strong>태그 알림 설정</strong></div>
                          <p>회원님이 태그된 게시물 알림</p>
                        </div>
                      </div>
                      <div class="col-sm-3">
