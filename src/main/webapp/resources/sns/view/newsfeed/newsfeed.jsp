    	...
    	<div class="container">
          ...
          ================================================= -->
            ...
            <div class="profile-card">
            	...
            	<a href="#" class="text-white"><i class="ion ion-android-person-add"></i> 1,299 followers 내 팔로</a>
         ...
         <%-- <li><i class="icon ion-images"></i><div><a href="${pageContext.request.contextPath}/sns/view/newsfeed/newsfeed-images.jsp">이미지</a></div></li>
            ...
            <div id="chat-block">
              ...
              <ul class="online-users list-inline">
                <li><a href="${pageContext.request.contextPath}/sns/view/newsfeed/newsfeed-messages.jsp" title="Linda Lohan"><img src="http://placehold.it/300x300" alt="user" class="img-responsive profile-photo" /><span class="online-dot"></span></a></li>
                <li><a href="${pageContext.request.contextPath}/sns/view/newsfeed/newsfeed-messages.jsp" title="Sophia Lee"><img src="http://placehold.it/300x300" alt="user" class="img-responsive profile-photo" /><span class="online-dot"></span></a></li>
                <li><a href="${pageContext.request.contextPath}/sns/view/newsfeed/newsfeed-messages.jsp" title="John Doe"><img src="http://placehold.it/300x300" alt="user" class="img-responsive profile-photo" /><span class="online-dot"></span></a></li>
                <li><a href="${pageContext.request.contextPath}/sns/view/newsfeed/newsfeed-messages.jsp" title="Alexis Clark"><img src="http://placehold.it/300x300" alt="user" class="img-responsive profile-photo" /><span class="online-dot"></span></a></li>
                <li><a href="${pageContext.request.contextPath}/sns/view/newsfeed/newsfeed-messages.jsp" title="James Carter"><img src="http://placehold.it/300x300" alt="user" class="img-responsive profile-photo" /><span class="online-dot"></span></a></li>
                <li><a href="${pageContext.request.contextPath}/sns/view/newsfeed/newsfeed-messages.jsp" title="Robert Cook"><img src="http://placehold.it/300x300" alt="user" class="img-responsive profile-photo" /><span class="online-dot"></span></a></li>
                <li><a href="${pageContext.request.contextPath}/sns/view/newsfeed/newsfeed-messages.jsp" title="Richard Bell"><img src="http://placehold.it/300x300" alt="user" class="img-responsive profile-photo" /><span class="online-dot"></span></a></li>
                <li><a href="${pageContext.request.contextPath}/sns/view/newsfeed/newsfeed-messages.jsp" title="Anna Young"><img src="http://placehold.it/300x300" alt="user" class="img-responsive profile-photo" /><span class="online-dot"></span></a></li>
                <li><a href="${pageContext.request.contextPath}/sns/view/newsfeed/newsfeed-messages.jsp" title="Julia Cox"><img src="http://placehold.it/300x300" alt="user" class="img-responsive profile-photo" /><span class="online-dot"></span></a></li>
              </ul>
            </div><!--chat block ends-->
          </div>
